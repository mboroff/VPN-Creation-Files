...
powershell -NoProfile -ExecutionPolicy Bypass -Command "$VpnName = 'MundeleinVPN'; $Server = 'MundeleinVPN.ddns.net'; $Psk = 'vpn'; $User = 'wa9ivh'; $Pass = 'wa9ivh344'; Add-VpnConnection -Name $VpnName -ServerAddress $Server -TunnelType L2tp -L2tpPsk $Psk -EncryptionLevel Required -AuthenticationMethod MSChapv2 -RememberCredential -AllUserConnection -Force" 
...
cmdkey /generic:"MundeleinVPN" /user:"wa9ivh" /pass:"wa9ivh344" 
:: Create Public Desktop shortcuts 
powershell -NoProfile -ExecutionPolicy Bypass -Command "$s=New-Object -ComObject WScript.Shell; $k=$s.CreateShortcut('C:\Users\Public\Desktop\MundeleinVPN Connect.lnk'); $k.TargetPath='cmd.exe'; $k.Arguments='/c echo Connecting to MundeleinVPN... [and] rasdial \"MundeleinVPN\" \"wa9ivh\" \"wa9ivh344\" [and] timeout /t 3' -replace '\[and\]','&'; $k.WindowStyle=1; $k.IconLocation='shell32.dll,135'; $k.Save()" 
