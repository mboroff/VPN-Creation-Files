...
set "EmailFile1=!User!-unattended-!VpnName!-Email-Template.html"
set "EmailFile2=!User!-MacOS-attended-!VpnName!-Email-Template.html"
set "EmailFile3=!User!-Windows-attended-!VpnName!-Email-Template.html"
