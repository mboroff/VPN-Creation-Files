...
powershell -NoProfile -ExecutionPolicy Bypass -Command "$VpnName = 'Northbrookpi'; $Server = 'Northbrookpi.ddns.net'; $Psk = 'vpn'; $User = 'wd9gym'; $Pass = 'Wd9gym95xy'; Add-VpnConnection -Name $VpnName -ServerAddress $Server -TunnelType L2tp -L2tpPsk $Psk -EncryptionLevel Required -AuthenticationMethod MSChapv2 -RememberCredential -AllUserConnection -Force" 
...
cmdkey /generic:"Northbrookpi" /user:"wd9gym" /pass:"Wd9gym95xy" 
:: Create Public Desktop shortcuts 
powershell -NoProfile -ExecutionPolicy Bypass -Command "$s=New-Object -ComObject WScript.Shell; $k=$s.CreateShortcut('C:\Users\Public\Desktop\Northbrookpi Connect.lnk'); $k.TargetPath='cmd.exe'; $k.Arguments='/c echo Connecting to Northbrookpi... [and] rasdial \"Northbrookpi\" \"wd9gym\" \"Wd9gym95xy\" [and] timeout /t 3' -replace '\[and\]','&'; $k.WindowStyle=1; $k.IconLocation='shell32.dll,135'; $k.Save()" 
powershell -NoProfile -ExecutionPolicy Bypass -Command "$s=New-Object -ComObject WScript.Shell; $k=$s.CreateShortcut('C:\Users\Public\Desktop\Northbrookpi Disconnect.lnk'); $k.TargetPath='cmd.exe'; $k.Arguments='/c echo Disconnecting from Northbrookpi... [and] rasphone.exe -h \"Northbrookpi\" [and] timeout /t 3' -replace '\[and\]','&'; $k.WindowStyle=1; $k.IconLocation='shell32.dll,131'; $k.Save()" 
echo. 
